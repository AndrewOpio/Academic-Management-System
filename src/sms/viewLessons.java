...
public class viewLessons extends JPanel {
    ...
    public void getLessons(String st_class) {
		...
		String query = "select * from timetable where class_id='" + st_class + "'";
	 ...
	 * Create the panel.
	 */
	public viewLessons(String st_class) {
		getLessons(st_class);
		...
		JLabel lblNewLabel = new JLabel("Students' Lessons");

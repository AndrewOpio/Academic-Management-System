...
public class viewTimetable extends JPanel {
    ...
    public void getTimetable() {
		...
		String query = "select first_period, first_period_teacher, second_period, second_period_teacher, third_period, third_period_teacher, fourth_period, fourth_period_teacher, fifth_period, fifth_period_teacher, sixth_period, sixth_period_teacher from timetable";
	...
	public viewTimetable() {
		...
		JLabel lblNewLabel = new JLabel("Students' Timetable");

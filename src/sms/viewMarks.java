...
public class viewMarks extends JPanel {
    ...
    public void getMarks(String reg_number) {
		...
		String query = "select * from results where reg_number='" + reg_number + "'";
	 ...
	 * Create the panel.
	 */
	public viewMarks(String reg_number) {
		getMarks(reg_number);
		...
		JLabel lblNewLabel = new JLabel("Student's Marks");

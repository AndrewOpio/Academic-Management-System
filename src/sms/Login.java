...
public class Login extends JFrame {
    ...
    public void userAuth(String name, String pass) throws SQLException {
    	...
    	if(name.equals("") || pass.equals("")) {
    		...
    		String query = "select * from teacher where username='" + name + "'and password='" + pass + "'";
    		ResultSet res = conn.getData(query);

    		if(!res.isBeforeFirst()) {
        		String query_1 = "select * from student where reg_number='" + name + "'and password='" + pass + "'";
        		...
        		if(!res_1.isBeforeFirst()) {
        			...
        			if(res_1.next()) {
        			   st_class = res_1.getString("class_id");
        			}
